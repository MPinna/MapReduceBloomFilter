...
\title{
    ...
    \rule{7cm}{0.01cm}\\
    {\normalsize{\scshape Cloud}}\\
    [2cm]
    {\scshape <title of the project>}\\
    [3cm]
    \LARGE{\textbf{Supervisors}\hfill\textbf{Student(s)}}\\
    \Large{\emph{Professor 1}\hfill\emph{Marco Pinna\\}}
    \Large{\emph{Professor 2}\hfill}
    \vfill
    \date{\today}
}
